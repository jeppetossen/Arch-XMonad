icon="/home/otiuz/.icons/xbm8x8/arrow_big_02.xbm"
phones="/home/otiuz/.icons/xbm8x8/phones.xbm"
...
while :; do
echo "^ca(1, sh /home/otiuz/scripts/mpdcontrol.sh)$(music)^ca()$(volmpd) "
sleep 1
done | dzen2 -p -h 22 -ta l -y 1004 -w 700 -bg "#101010" -fg "#101010" -fn "M+ 1m-8" -e 'button3=' -title-name dzenbottom && sleep .01s && transset-df -n dzenbottom 0.9
